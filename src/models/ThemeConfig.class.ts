...
export class ThemeConfig {
  ...
  constructor(raw?: ThemeRaw) {
    ...
    if (rawConfig) {
      ...
      this.friends = new Friends(rawConfig.friends)
    }
  }
}
...
export class Friend {
  ...
  constructor(friend?: GeneralOptions) {
    if (friend) {
      for (const key of Object.keys(this)) {
        Object.assign(this, { [key]: friend[key] })
      }
    }
  }
}
...
export class Friends {
  ...
  constructor(friends?: { [key: string]: any }) {
    if (friends) {
      Object.assign(
        this.friends,
        Object.keys(friends).map((key: string) => new Friend(friends[key]))
      )
    }
  }
}
